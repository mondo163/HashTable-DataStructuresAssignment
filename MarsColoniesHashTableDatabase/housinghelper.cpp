/*********************************************************
* This is the starting point for the project that 
* was given to us by our professor. All classes 
* implemented in this starter file were to be implemented
* by us and to had to pass by running this main file. 
*********************************************************/
...
int main(int argc,char** argv)
{
	...
	while (infile.getline(line,MAX_LINE) )
	{
	    ...
	    strncpy_s(id,s,MAX_LINE);

	    // Name
	    infile.getline(line,MAX_LINE);
	    s = strchr(line,':') + 2;  // Skip the space
	    strncpy_s(name,s,MAX_LINE);
	...
	infile.close();
	//Edited after the class was over to both print the contents to the console and to a file
	familyMgr.printAllFamiliesToConsole();
	familyMgr.printAllFamiliesToFile();
